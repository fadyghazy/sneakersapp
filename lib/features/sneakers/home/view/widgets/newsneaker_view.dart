...
import 'package:sneakers_store/features/sneakers/home/view/widgets/new_sneakers_card.dart';
import 'package:sneakers_store/features/sneakers/home/view/widgets/sneaker_card.dart';

class NewSneakersView extends StatefulWidget {
  const NewSneakersView({required this.sneakers, super.key});

  final List<Sneaker> sneakers;

  @override
  State<NewSneakersView> createState() => _NewSneakersViewState();
}

class _NewSneakersViewState extends State<NewSneakersView> {
            ...
            return AnimatedBuilder(
              ...
              builder: (context, child) {
                ...
                return AnimatedPadding(
                  ...
                  child: NewSneakerCard(size: size,sneaker: sneaker,

...
import 'package:sneakers_store/translate.dart';
 Sneakers mockSneakers = Sneakers(
  brands: [
    Brand(
      id: 1,
    ...
    Brand(
      ...
      featured: [
        ...
        Sneaker(
          ...
          brandName: '${Translate.ReebokBrand2}',
          price: 170,
          type: SneakerType.featured,
          color: Colors.grey,
          assets: [
      ...
      upcoming: [
        ...
        Sneaker(
          id: 3,
          shortName: '${Translate.UpcomingReebokShortName3}',
          name: '${Translate.UpcomingReebokName3}',
          brandName: '${Translate.UpcomingReebokBrand3}',
          price: 170,
          type: SneakerType.featured,
          color: Colors.redAccent,
          assets: [

...
import 'package:sneakers_store/screens/search/model/brand_model.dart';
import 'package:sneakers_store/screens/search/model/sneakers.dart';
...
class _SearchPageState extends State<SearchPage> {
  // I,m now going to create a dummy list of sneakers
  // you can build your own list ,i used the Sneakers data so you can use it
            ...
            itemCount: 12,
              itemBuilder: (context, index){
                return ListTile(
                  ...
                  title:Text(display_mock_Sneakers.brands[index].name,style: TextStyle(
